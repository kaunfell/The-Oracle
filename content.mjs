const answers = {
    ...
    "how long": [
        "Long enough.",
        "Too long.",
        "No idea. But how long to the next meal? I am hungry.",
        "How long? Is that a name?",
        "Something between 2 hours, 200 km and a one potato." //5
    ],
    ...
    what: [
        ...
        'There is not easy answer to "what".', //15
    ...
    'Not so sure, but my cat might know.', //CAT
    'Well... I would think about it.',
    "It could be 'yes' if you had a healthy breakfast.",
    'Oh, the magic ball just flew out of the window.',
    "Yes, if we are very precise, but we don't have to be.",
    'Ask the wizard looking guy next door.',
    'If I say "yes" do you believe me?',
     'If I say "no", do you believe me?',
    'Do I look like I know? Ok, I know. Hehe.',
    'Let me see... I will tell you later.',
